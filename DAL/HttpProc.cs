...
namespace DAL
{
    public class HttpProc
    {
        ...
        public class UploadEventArgs : EventArgs
        {
            int bytesSent;
            int totalBytes;
            #region 已发送的字节数 public int BytesSent
            /// <summary>    
            /// 已发送的字节数    
            /// </summary>    
            ...
            #region 总字节数 public int TotalBytes
            /// <summary>    
            /// 总字节数    
            /// </summary>    
        ...
        public class WebClient
        {
            ...
            #region 创建WebClient的实例 + public WebClient()
            /// <summary>    
            /// 创建WebClient的实例    
            /// </summary>    
            public WebClient()
            ...
            #region 设置发送和接收的数据缓冲大小 + public int BufferSize
            /// <summary>    
            /// 设置发送和接收的数据缓冲大小    
            /// </summary>    
            ...
            #region 获取响应头集合 + public WebHeaderCollection ResponseHeaders
            /// <summary>    
            /// 获取响应头集合    
            /// </summary>    
            ...
            #region  获取请求头集合 + public WebHeaderCollection RequestHeaders
            /// <summary>    
            /// 获取请求头集合    
            /// </summary>    
            ...
            #region 获取或设置代理 + public WebProxy Proxy
            /// <summary>    
            /// 获取或设置代理    
            /// </summary>    
            ...
            #region 获取或设置请求与响应的文本编码方式 +  public Encoding Encoding
            /// <summary>    
            /// 获取或设置请求与响应的文本编码方式    
            /// </summary>    
            ...
            #region 获取或设置响应的html代码 + public string RespHtml
            /// <summary>    
            /// 获取或设置响应的html代码    
            /// </summary>    
            ...
            #region 获取或设置与请求关联的Cookie容器 +  public CookieContainer CookieContainer
            /// <summary>    
            /// 获取或设置与请求关联的Cookie容器    
            /// </summary>    
            ...
            #region 获取网页源代码 + public string GetHtml(string url)
            /// <summary>    
            ///  获取网页源代码    
            /// </summary>    
            ...
            #region 下载文件 + public void DownloadFile(string url, string filename)
            /// <summary>    
            /// 下载文件    
            /// </summary>    
            ...
            #region 从指定URL下载数据 + public byte[] GetData(string url)
            /// <summary>    
            /// 从指定URL下载数据    
            /// </summary>    
            /// <param name="url">网址</param>    
            ...
            #region 向指定URL发送文本数据 + public string Post(string url, string postData)
            /// <summary>    
            /// 向指定URL发送文本数据    
            /// </summary>    
            /// <param name="url">网址</param>    
            ...
            #region 向指定URL发送字节数据　＋　public string Post(string url, byte[] postData)
            /// <summary>    
            /// 向指定URL发送字节数据    
            /// </summary>    
            /// <param name="url">网址</param>    
            ...
            #region 向指定网址发送mulitpart编码的数据　＋　public string Post(string url, MultipartForm mulitpartForm)
            /// <summary>    
            ...
            #region 读取请求返回的数据 +　private byte[] GetData(HttpWebRequest request)
            ...
            private byte[] GetData(HttpWebRequest request)
            {
                ...
                //HttpWebResponse response= (HttpWebResponse)request.GetResponse();//原有
            ...
            #region 发送请求数据 + private void PostData(HttpWebRequest request, byte[] postData)
            /// <summary>    
            /// 发送请求数据    
            /// </summary>    
            /// <param name="request">请求对象</param>    
            ...
            #region 创建HTTP请求 +  private HttpWebRequest CreateRequest(string url, string method)
            /// <summary>    
            /// 创建HTTP请求    
            /// </summary>    
            ...
            #region 将Cookie保存到磁盘 +　private static void SaveCookiesToDisk()
            /// <summary>    
            /// 将Cookie保存到磁盘    
            /// </summary>    
            ...
            #region 从磁盘加载Cookie + private static void LoadCookiesFromDisk()
            /// <summary>    
            /// 从磁盘加载Cookie    
            /// </summary>    
        ...
        public class MultipartForm
        {
            ...
            #region 获取编码后的字节数组 + public byte[] FormData
            /// <summary>    
            /// 获取编码后的字节数组    
            /// </summary>    
            ...
            #region 获取此编码内容的类型 + public string ContentType
            /// <summary>    
            /// 获取此编码内容的类型    
            /// </summary>    
            ...
            #region 获取或设置对字符串采用的编码类型 + public Encoding StringEncoding
            /// <summary>    
            /// 获取或设置对字符串采用的编码类型    
            /// </summary>    
            ...
            #region 实例化 public MultipartForm()
            /// <summary>    
            /// 实例化    
            /// </summary>    
            ...
            #region 添加一个文件 + public void AddFlie(string name, string filename)
            /// <summary>    
            /// 添加一个文件    
            /// </summary>    
            ...
            #region 添加一个文件+ public void AddFlie(string name, string filename, byte[] fileData, int dataLength)
            /// <summary>    
            /// 添加一个文件    
            /// </summary>    
            /// <param name="name">文件域名称</param>    
            ...
            #region 添加字符串 + public void AddString(string name, string value)
            /// <summary>    
            /// 添加字符串    
            /// </summary>    
            ...
            #region 从注册表获取文件类型 + private string GetContentType(string filename)
            /// <summary>    
            /// 从注册表获取文件类型    
            /// </summary>    
